...
def edgeDetector(image):
  blur_image = cv2.GaussianBlur(gray_image, (5,5), 0)    # Converting grayscale image to blur image
  canny_image = cv2.Canny(blur_image, 80, 255)  
...
region_of_interest_points = [ (0,height) , (650,170) ,(1280,720)]  #finding the region of interest parameter value
